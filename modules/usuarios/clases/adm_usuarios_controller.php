...
class adm_usuarios_controller{
    ...
    public function fntPost(){
        ...
        if( isset($_POST['hdnUsuario'])){
            ...
            $strNOmbreUsuario = isset($_POST["txtNombreDeUsuario"]) ? $_POST["txtNombreDeUsuario"]: "";
            ...
            if( $intUsuario > 0 ){
                 ...
                 $this->objModel->fntUpdateUsuario( $intUsuario, $strNombre1, $strNombre2 , $strApellido1, $strApellido2, $strApellidoCasada, $strEmail, $strUsuario, $strNOmbreUsuario, $strContrasena ,$chkActivo, $slcTipo );
            
            }
            else{
               $intUsuario  =  $this->objModel->fntInsertUsuario( $intUsuario, $strNombre1, $strNombre2 , $strApellido1, $strApellido2, $strApellidoCasada, $strEmail, $strUsuario, $strNOmbreUsuario, $strContrasena ,$chkActivo, $slcTipo );
