...
//include_once("adm_usuarios_controller.php");  municipios

require_once("modules/configuracion/clases/configuracion_municipios_model.php");

class configuracion_municipios_view{
    
    private $objModel;
    private $objView;
    
    public function __construct(){
        $this->objModel = new configuracion_municipios_model();
    }
         ...
         <div class="row">
            <div class="col-lg-12" align="right" >
                <h1 class="page-header" id="btnHeadder" >
                    <p><button type="button" class="btn btn-outline btn-primary btn-sm" onclick="document.location.href='<?php print $strAction; ?>?municipio=new'" >Nuevo</button></p>
                </h1>
            </div>
        </div>
                                    ...
                                    <tbody>
                                        <?php
                                           foreach (  $arrGetDepto as $arrTMP  ){
                                               ...
                                               <tr>
                                                   <td>
                                                       <a href="<?php echo $strAction."?municipio=".md5($arrTMP["municipio"]); ?>" class="link"><?php echo $arrTMP["nombre"]; ?></a>
                                                   </td>
    ...
    public function drawContentDepto($strMunicipio){
        global $strAction;
        //print $strDepto;
        $arrInfoDepto = $this->objModel->getEtniaId($strMunicipio);
        
        $boolModoEdicion = $strMunicipio != "new" ? true : false;
                                                ...
                                                <div id="divReqTienda" class="form-group ocultar">
                                                    <div class="col-md-12">
                                                        <?php 
                                                            ...
                                                            $intDepto = isset($arrInfoDepto["municipio"]) ? $arrInfoDepto["municipio"] : 0;
